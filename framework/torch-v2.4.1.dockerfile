...
# install driver.
RUN set -x \
&& wget -nv http://10.113.3.1/corex/toolbox/nvidia/NVIDIA-Linux-x86_64-570.153.02.run -P /tmp \
&& bash /tmp/NVIDIA-Linux-x86_64-570.153.02.run --extract-only --target /tmp/umd \
&& cp /tmp/umd/libcuda.so.570.153.02 /usr/lib/x86_64-linux-gnu \
&& ln -sf /usr/lib/x86_64-linux-gnu/libcuda.so.570.153.02 /usr/lib/x86_64-linux-gnu/libcuda.so.1 \
&& ln -sf /usr/lib/x86_64-linux-gnu/libcuda.so.1 /usr/lib/x86_64-linux-gnu/libcuda.so \
&& cp /tmp/umd/libnvidia-ml.so.570.153.02 /usr/lib/x86_64-linux-gnu \
&& ln -sf /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.570.153.02 /usr/lib/x86_64-linux-gnu/libnvidia-ml.so.1 \
...
RUN set -x \
&& git clone -b master --recursive https://github.com/knote2019/torch-v2.4.1.git /opt/torch \
